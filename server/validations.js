...
export const contactCreateValidation = [
    body("whatsapp", "Введите текст статьи").isLength({min: 10}).isString(),
    body("phone", "Введите текст статьи").isLength({min: 10}).isString(),
    body("details", "Введите текст статьи").isLength({min: 10}).isString(),
